...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     * or this method is called on a closed connection
     */
    PreparedStatement prepareStatement(@NotDangerousSql String sql)
        throws SQLException;
     ...
     * or this method is called on a closed connection
     */
    CallableStatement prepareCall(@NotDangerousSql String sql) throws SQLException;
     ...
     * or this method is called on a closed connection
     */
    String nativeSQL(@NotDangerousSql String sql) throws SQLException;
     ...
     * @since 1.2
     */
    PreparedStatement prepareStatement(@NotDangerousSql String sql, int resultSetType,
     ...
     * @since 1.2
     */
    CallableStatement prepareCall(@NotDangerousSql String sql, int resultSetType,
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@NotDangerousSql String sql, int autoGeneratedKeys)
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@NotDangerousSql String sql, int columnIndexes[])
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@NotDangerousSql String sql, String columnNames[])
        throws SQLException;
