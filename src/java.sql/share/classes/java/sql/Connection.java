...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     * or this method is called on a closed connection
     */
    PreparedStatement prepareStatement(@Sql String sql)
        throws SQLException;
     ...
     * or this method is called on a closed connection
     */
    CallableStatement prepareCall(@Sql String sql) throws SQLException;
     ...
     * or this method is called on a closed connection
     */
    String nativeSQL(@Sql String sql) throws SQLException;
     ...
     * @since 1.2
     */
    PreparedStatement prepareStatement(@Sql String sql, int resultSetType,
     ...
     * @since 1.2
     */
    CallableStatement prepareCall(@Sql String sql, int resultSetType,
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@Sql String sql, int autoGeneratedKeys)
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@Sql String sql, int columnIndexes[])
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@Sql String sql, String columnNames[])
        throws SQLException;
